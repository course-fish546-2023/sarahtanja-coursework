...
::: {.callout-tip}  
I particularly like the `::: {callout-tip}  :::` code wrap that automatically highlights and formats text for different purposes (note, warning, important, tip, caution). 
:::
