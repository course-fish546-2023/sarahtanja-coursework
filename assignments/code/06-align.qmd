...
::: callout-warning
This SAM file is 63.9GB and takes a long time to generate! If it takes too long, you can skip cheat and instead point to `/home/shared/8TB_HDD_01/sr320/github/steven-crabby-duck/F143_cgigas_sorted.bam`
:::
...
```
```{r, engine='bash'}
head ~/home/shared/8TB_HDD_01/sr320/github/steven-crabby-duck/F143_cgigas_sorted.bam
```
...
/home/shared/8TB_HDD_01/sr320/github/steven-crabby-duck/F143_cgigas_sorted.bam > ../output/F143_mpileup_output.txt
```
