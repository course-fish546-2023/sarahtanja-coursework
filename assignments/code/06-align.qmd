...
Download IGV software and install it on your local machine <https://software.broadinstitute.org/software/igv/download> In my case, I downloaded "[IGV for Windows, Java Included](https://data.broadinstitute.org/igv/projects/downloads/2.16/IGV_Win_2.16.1-WithJava-installer.exe)"

Skim the [IGV User Guide](https://software.broadinstitute.org/software/igv/book/export/html/6) ... however it's difficult to navigate and not particularly useful.

Download `F143_mpile.vcf.gz` to local machine ?
