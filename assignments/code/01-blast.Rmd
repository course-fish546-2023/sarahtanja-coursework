...
This assignment is to take set of unknown protein sequences, and annotate them with GO terms using BLAST  (Basic Local Alignment Search Tool).

What is a Gene Ontology (GO) term? 👀 see this [introduction to GO annotation](http://geneontology.org/docs/go-annotations/).
