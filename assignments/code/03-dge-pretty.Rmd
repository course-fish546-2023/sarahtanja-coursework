...
Here the code creates a `data.frame` named `deseq2.dds` containing information about the experimental conditions. and . It uses this information to create a `DESeqDataSet` object, 
...
# DESeqDataSet object created using `the following`DESeqDataSetFromMatrix` function
